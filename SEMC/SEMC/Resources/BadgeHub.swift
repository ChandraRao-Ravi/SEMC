...
let notificHubDefaultDiameter: CGFloat = 25
...
public class BadgeHub: NSObject {
    ...
    public func setView(_ view: UIView?, andCount startCount: Int) {
        ...
        setCircleAtFrame(CGRect(x: (frame?.size.width ?? 0.0) - ((notificHubDefaultDiameter) * 2 / 3), y: (-notificHubDefaultDiameter) / 3, width: CGFloat(25), height: CGFloat(25)))
    ...
    public func setCircleAtFrame(_ frame: CGRect) {
        ...
        countLabel?.font = UIFont(name: "SFProText-Bold", size: 15.0)
